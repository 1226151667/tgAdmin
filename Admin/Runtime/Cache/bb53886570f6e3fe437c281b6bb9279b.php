    ...
    <div class="main-content" >
        ...
        <div class="wrapper">
             <div class="row">
                ...
                <tbody>
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr class="" id="<?php echo ($row["id"]); ?>">
...
<script type="text/javascript" src="__PUBLIC__/js/reset.js"></script>
...
<script>
    jQuery(document).ready(function() {
        ...
        $(".edit").click(function(){
            ...
            var jdTd = jdTr.find("td");
            var id = jdTr.attr("id");
            var name = jdTd[0].innerHTML;
            var url = jdTd[1].innerHTML;
            $(".logT").text("修改-活动页面");
            $(".logId input").val(id);
        ...
        $(".delete").click(function(){
            if(confirm("如果删除此数据，会连同其关联数据一块删除")){
                var id = $(this).parent().parent().attr("id");
                $.get(
                        '<?php echo U("User/delPage3");?>',
                        {id:id},
                        function(data){
                            if(data==0){
                                alert("删除成功");
