...
<!--                 <li>
        ...
        <tr>
            ...
            <th class="hidden-phone">验证</th>
        </tr>
        <?php switch($User["level"]): case "1": ?>value1<?php break;?>
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr class="gradeA">
                ...
                <td>
                    ...
                    <a target="_blank" href="<?php echo ($row["url"]); ?>?ikey=<?php echo ($row["parameter"]); ?>">
                        <?php echo ($row["pageName"]); ?>><?php echo ($row["lKeyword"]); ?>
                    </a>
                </td>
                <td>
                    <a target="_blank" href="<?php echo ($row["url"]); ?>?ikey=<?php echo ($row["parameter"]); ?>">
                ...
                <td class="center hidden-phone">
                    <?php if($row['isChecked']==0): ?>未验证
                        <?php else: ?>已验证<?php endif; ?>
                </td>
...
<script src="__PUBLIC__/js/reset.js"></script>
